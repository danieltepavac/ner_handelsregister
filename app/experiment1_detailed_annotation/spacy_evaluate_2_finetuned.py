...
model_directory = Path(Path(__file__).parents[1], "../models/experiment1_detailed_annotation/ner2_finetuned")
...
save_path = Path(Path(__file__).parents[1], "../results/experiment1_detailed_annotation/2_finetuned.json")
