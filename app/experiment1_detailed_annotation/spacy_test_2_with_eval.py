...
path = Path(Path(__file__).parents[1], "../data/experiment1_detailed_annotation/train_data.json")

train_path = Path(Path(__file__).parents[1], "../data/experiment1_detailed_annotation/train_data.json")
val_path = Path(Path(__file__).parents[1], "../data/experiment1_detaield_annotation/eval_data.json")
...
output_dir=Path(Path(__file__).parents[1], "../models/experiment1_detailed_annotation/ner2_with_eval/")
