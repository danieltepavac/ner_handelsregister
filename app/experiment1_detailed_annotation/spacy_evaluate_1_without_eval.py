...
model_directory = Path(Path(__file__).parents[1], "../models/experiment1_detailed_annotation/ner1_without_eval")
...
save_path = Path(Path(__file__).parents[1], "../results/experiment1_detailed_annotation/1_without_eval.json")
