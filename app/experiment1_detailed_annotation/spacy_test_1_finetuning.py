...
# Training of own model with train_data and fine-tuned on German LM. 
...
output_dir=Path(Path(__file__).parents[1], "../models/experiment1_detailed_annotation/ner1_finetuned/")
