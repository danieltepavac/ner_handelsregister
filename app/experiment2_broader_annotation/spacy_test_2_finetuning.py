...
train_path = Path(Path(__file__).parents[1], "../data/experiment2_broader_annotation/train_data.json")
val_path = Path(Path(__file__).parents[1], "../data/experiment2_broader_annotation/eval_data.json")
...
output_dir=Path(Path(__file__).parents[1], "../models/experiment2_broader_annotation/ner2_finetuned/")
