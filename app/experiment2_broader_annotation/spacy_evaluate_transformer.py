...
model_directory = Path(Path(__file__).parents[1], "../models/experiment2_broader_annotation/output_plain_de/model-best")
...
save_path = Path(Path(__file__).parents[1], "../results/experiment2_broader_annotation/transformers.json")
