...
path = Path(Path(__file__).parents[1], "../data/experiment2_broader_annotation/train_data.json")
...
output_dir=Path(Path(__file__).parents[1], "../models/experiment2_broader_annotation/ner1_finetuned/")
