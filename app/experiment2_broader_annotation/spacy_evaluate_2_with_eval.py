...
model_directory = Path(Path(__file__).parents[1], "../models/experiment2_broader_annotation/ner2_with_eval")
...
save_path = Path(Path(__file__).parents[1], "../results/experiment2_broader_annotation/2_with_eval.json")
