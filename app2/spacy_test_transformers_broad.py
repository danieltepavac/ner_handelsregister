...
path_train = Path(Path(__file__).parent, "../data/broader_train_data.json")
path_dev = Path(Path(__file__).parent, "../data/broader_eval_data.json")
...
train_docbin.to_disk("./broader_train.spacy")


test_docbin = DocBin(docs=docs_dev)
test_docbin.to_disk("./broader_dev.spacy")