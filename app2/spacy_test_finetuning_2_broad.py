...
train_path = Path(Path(__file__).parent, "../data/broader_train_data.json")
val_path = Path(Path(__file__).parent, "../data/broader_eval_data.json")
...
output_dir=Path("ner2_finetuned_broad/")
